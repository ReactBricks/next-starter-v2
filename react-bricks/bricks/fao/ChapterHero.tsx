  ...
  return (
    <div className="relative">
      ...
      <div className="absolute text-[#018da0] top-0 bg-white/90 w-[380px] h-full ml-[calc(((100%-1280px)/2)+260px+2rem*2)] break-words py-0 px-8 mr-auto max-w-[680px] flex flex-col items-start justify-center">
        <h2 className="leading-[2rem] text-[2rem] w-4/5 max-w-[680px] font-black not-italic font-[trade-gothic-next-condensed,sans-serif] z-[98] pt-4 uppercase -tracking-[0.35px] before:w-1/4 before:content-[''] before:h-[10px] before:bg-[#018da0] before:inline-block before:absolute before:top-0 before:left:0 flex flex-col relative">
          <Text
            renderBlock={(props) => (
